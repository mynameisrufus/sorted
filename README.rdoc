...
This will initially sort by email ascending:
  ...
  @users = User.sorted(:email, params[:sort]).paginate(:page => params[:page])

This will initially sort by email descending:

  @users = User.sorted('email DESC', params[:sort]).paginate(:page => params[:page])
